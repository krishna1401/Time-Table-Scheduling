...
public class Data {
    ...
    private Data initialize(){
        ...
        time_slots.addAll(Arrays.asList(time1,time2,time3,time4,time5));
        time1 = new TimeSlot("Mo4",12,1,"Monday");
        time2 = new TimeSlot("Tu4",12,1,"Tuesday");
        time3 = new TimeSlot("We4",12,1,"Wednesday");
        time4 = new TimeSlot("Th4",12,1,"Thrusday");
        time5 = new TimeSlot("Fr4",12,1,"Friday");
        time_slots.addAll(Arrays.asList(time1,time2,time3,time4,time5));
        time1 = new TimeSlot("Mo5",1,2,"Monday");
        time2 = new TimeSlot("Tu5",1,2,"Tuesday");
        time3 = new TimeSlot("We5",1,2,"Wednesday");
        time4 = new TimeSlot("Th5",1,2,"Thrusday");
        time5 = new TimeSlot("Fr5",1,2,"Friday");
        time_slots.addAll(Arrays.asList(time1,time2,time3,time4,time5));
        time1 = new TimeSlot("Mo6",2,3,"Monday");
        time2 = new TimeSlot("Tu6",2,3,"Tuesday");
        time3 = new TimeSlot("We6",2,3,"Wednesday");
        time4 = new TimeSlot("Th6",2,3,"Thrusday");
        time5 = new TimeSlot("Fr6",2,3,"Friday");
        time_slots.addAll(Arrays.asList(time1,time2,time3,time4,time5));
        time1 = new TimeSlot("Mo7",3,4,"Monday");
        time2 = new TimeSlot("Tu7",3,4,"Tuesday");
        time3 = new TimeSlot("We7",3,4,"Wednesday");
        time4 = new TimeSlot("Th7",3,4,"Thrusday");
        time5 = new TimeSlot("Fr7",3,4,"Friday");
        time_slots.addAll(Arrays.asList(time1,time2,time3,time4,time5));
        time1 = new TimeSlot("Mo8",4,5,"Monday");
        time2 = new TimeSlot("Tu8",4,5,"Tuesday");
        time3 = new TimeSlot("We8",4,5,"Wednesday");
        time4 = new TimeSlot("Th8",4,5,"Thrusday");
        time5 = new TimeSlot("Fr8",4,5,"Friday");
        time_slots.addAll(Arrays.asList(time1,time2,time3,time4,time5));
